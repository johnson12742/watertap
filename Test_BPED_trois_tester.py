...
class Test_operation_Method:
    ...
    def bped_model(self):
        ...
        m.fs.unit.inlet_aem_side.flow_mol_phase_comp[0, "Liq", "C_+"].fix(
            7.38e-4 * self.factor
        )
        m.fs.unit.inlet_aem_side.flow_mol_phase_comp[0, "Liq", "A_-"].fix(
            7.38e-4 * self.factor
        )
        ...
        m.fs.unit.inlet_cem_side.flow_mol_phase_comp[0, "Liq", "C_+"].fix(
            7.38e-4 * self.factor
        )
        m.fs.unit.inlet_cem_side.flow_mol_phase_comp[0, "Liq", "A_-"].fix(
            7.38e-4 * self.factor
        )
