    ...
    def build(self):
        ...
        def eq_current_dens_lim_bpem(self, t):
            if (
                ...
                # if self.config.has_catalyst == True:
                #     catalyst_factor = (self.membrane_fixed_catalyst_cem["bpem"]/self.k_a["bpem"]
            ...
            if self.config.has_catalyst == True:
                ...
                if (
                    ...
                    def eq_potential_lim_bpem_non_dim(self, t):
                        ...
                        # matrx += -pyunits.convert(self.kr["bpem"],
                        #                           to_units=pyunits.meter ** 3 * pyunits.mole ** -1 * pyunits.second ** -1) * kw
                        return (
        ...
        def eq_current_voltage_relation(self, t, p):
            ...
            if self.config.has_catalyst == False:
                ...
                def eq_current_relationship(self, t):
                    ...
                    # return self.potential_lim_bpem[t] + self.potential_membrane_bpem[t]== self.voltage[t]
