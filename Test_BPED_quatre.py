...
m.fs.unit = Electrodialysis0D(
    ...
    limiting_current_density_data=1e0 * factor,
...
m.fs.unit.inlet_aem_side.flow_mol_phase_comp[0, "Liq", "C_+"].fix(7.38e-4 * factor)
m.fs.unit.inlet_aem_side.flow_mol_phase_comp[0, "Liq", "A_-"].fix(7.38e-4 * factor)
...
m.fs.unit.inlet_cem_side.flow_mol_phase_comp[0, "Liq", "C_+"].fix(7.38e-4 * factor)
m.fs.unit.inlet_cem_side.flow_mol_phase_comp[0, "Liq", "A_-"].fix(7.38e-4 * factor)
...
m.fs.properties.set_default_scaling(
    "flow_mol_phase_comp", 1e1 * factor**-1, index=("Liq", "H2O")
)
m.fs.properties.set_default_scaling(
...
m.fs.properties.set_default_scaling(
    "flow_mol_phase_comp", 1e3 * factor**-1, index=("Liq", "C_+")
)
m.fs.properties.set_default_scaling(
    "flow_mol_phase_comp", 1e3 * factor**-1, index=("Liq", "A_-")
)
# print("420")
